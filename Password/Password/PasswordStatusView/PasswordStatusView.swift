...
//  Password
//
//  Created by Alexis Horteales Espinosa on 07/06/25.
//
...
extension PasswordStatusView{
    func style(){
        ...
        stackView.distribution = .equalCentering   //remove  ambiguity from stack views
    ...
    func layout(){
        ...
        NSLayoutConstraint.activate([
            ...
            bottomAnchor.constraint(equalToSystemSpacingBelow: stackView.bottomAnchor
                                    , multiplier: 2)
        ])
...
extension PasswordStatusView{
    ...
    func validate(_ text: String) -> Bool{
        ...
        let checkable = [uppercaseMet, lowercaseMet, digitMet, specialCharMet]
