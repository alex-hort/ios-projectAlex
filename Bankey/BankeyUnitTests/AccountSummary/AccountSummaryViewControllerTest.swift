...
//  Bankey
//
//  Created by Alexis Horteales Espinosa on 28/05/25.
//
...
class AccountSummaryViewControllerTests: XCTestCase {
    ...
    func testAlertForDecodinfError() throws {
        mockManager.error = NetworkError.decodingError
        vc.forceFetchProfile()
        
        XCTAssertEqual("Network Error", vc.errorAlert.title)
        XCTAssertEqual("Ensure you are connected to the internet. Please try again.", vc.errorAlert
            .message)
    }
}
